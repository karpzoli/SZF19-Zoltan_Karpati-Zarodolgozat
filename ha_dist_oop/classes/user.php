...
class User {
    ...
    public function __construct($user = null) { //default parameter is null
    ...
    public function hasPermission($key) {
        //checks if role set for user exists in Roles table
        if($this->_db->get('roles', array('role_id', '=', $key))){      
